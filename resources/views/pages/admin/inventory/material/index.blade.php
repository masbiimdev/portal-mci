        ...
        <div class="table-responsive">
            <table id="materialsTable" class="table table-bordered table-striped align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        <td></td> {{-- akan diisi otomatis oleh DataTables --}}
                        ...
                        <td class="text-center">{{ $m->rack->rack_name ?? '-' }}</td>
...
$(function() {
    const table = $('#materialsTable').DataTable({
        ...
        responsive: true,
        columnDefs: [
            { orderable: false, searchable: false, targets: 0 } // kolom No tidak bisa disort
        ],
        language: {
            search: "Cari:",
