...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light">Quality Control / Master Alat /</span> Tambah Alat Baru
        </h4>
            ...
            <div class="col-12 col-lg-10 col-xl-9">
                <div class="card shadow-sm border-0 rounded-3">
                    ...
                    <div class="card-header-custom d-flex align-items-center">
                        ...
                        <div>
                            <h5 class="mb-0 fw-bold text-dark">Informasi Alat QC Baru</h5>
                            <p class="mb-0 text-muted small">Lengkapi spesifikasi alat untuk didaftarkan ke sistem
                                kalibrasi.</p>
                        </div>
                    </div>
                        ...
                        <form action="{{ route('tools.store') }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="text" name="nama_alat" class="form-control"
                                                placeholder="Misal: Digital Flowmeter" value="{{ old('nama_alat') }}"
                                                required autofocus>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="text" name="merek" class="form-control"
                                                placeholder="Misal: SIARGO" value="{{ old('merek') }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="text" name="no_seri" class="form-control"
                                                placeholder="Misal: 246137" value="{{ old('no_seri') }}">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="text" name="kapasitas" class="form-control"
                                                placeholder="Misal: 0~20 SCFH" value="{{ old('kapasitas') }}">
                                        </div>
                                    </div>

                                    {{-- Lokasi (BUG FIXED: sebelumnya name="merek") --}}
                                    <div class="mb-3">
                                        <label class="form-label">Lokasi Penyimpanan</label>
                                        <div class="input-group input-group-merge">
                                            <span class="input-group-text"><i class="bx bx-map-pin"></i></span>
                                            <input type="text" name="lokasi" class="form-control"
                                                placeholder="Misal: Rak Penyimpanan QC" value="{{ old('lokasi') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                ...
                                <button type="submit" class="btn btn-primary px-4 shadow-sm">
                                    <i class="bx bx-save me-1"></i> Simpan Data Alat
                                </button>
                            </div>
