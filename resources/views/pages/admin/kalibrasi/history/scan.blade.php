                        ...
                        <article class="history-card">
                            <div class="d-flex justify-content-between">
                                <div>
                                    ...
                                    <span
                                        class="badge-status {{ $status === 'OK' ? 'badge-ok' : ($status === 'PROSES' ? 'badge-proses' : 'badge-due') }}">
                                        {{ $status ?? '-' }}
                                    </span>
                                </div>
    ...
    <div class="modal fade" id="pdfModal" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body p-0" style="height:80vh; max-height:90vh;">
                    <iframe id="pdfFrame" class="pdf-frame" src=""></iframe>
                </div>

                {{-- <div class="modal-footer d-flex justify-content-between flex-wrap">
                    <a id="pdfDownload" href="#" class="btn btn-outline-success mb-2" target="_blank">Download</a>
                    <button type="button" class="btn btn-secondary mb-2" data-bs-dismiss="modal">Tutup</button>
                </div> --}}
