...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light">Access Control / User /</span>
                    ...
                    <div class="card-header-custom d-flex align-items-center">
                        ...
                        <div>
                            <h5 class="mb-0 fw-bold text-dark">
                                {{ isset($user) ? 'Edit Data Pengguna' : 'Informasi Pengguna Baru' }}</h5>
                            <p class="mb-0 text-muted small">Lengkapi profil pengguna untuk memberikan hak akses ke dalam
                                sistem.</p>
                        </div>
                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="text" name="name" class="form-control"
                                                placeholder="Nama sesuai KTP" value="{{ old('name', $user->name ?? '') }}"
                                                required>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <select name="departemen" class="form-select" required>
                                                <option value="" disabled {{ !isset($user) ? 'selected' : '' }}>Pilih
                                                    Departemen...</option>
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">
                                            Password {{ isset($user) ? '' : '<span class="required-asterisk">*</span>' }}
                                        </label>
                                        <div class="input-group input-group-merge">
                                        ...
                                        @if (isset($user))
                                            <small class="text-muted mt-1 d-block"><i class="bx bx-info-circle"></i>
                                                Kosongkan jika tidak ingin mengubah password saat ini.</small>
                                        @endif
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">
                                            Konfirmasi Password
                                            {{ isset($user) ? '' : '<span class="required-asterisk">*</span>' }}
                                        </label>
                                        <div class="input-group input-group-merge">
