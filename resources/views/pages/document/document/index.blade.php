...
@section('content')
    <div class="container-main">
        ...
        <div class="breadcrumb-nav">
            ...
            <i class="bx bx-chevron-right"></i>
            <span style="color: var(--primary); font-weight: 700;">{{ $folder->folder_name }}</span>
        </div>
        ...
        <div class="page-header">
            <div class="header-main">
                ...
                <p>{{ $folder->description ?? 'Manajemen dokumen resmi, revisi, dan status transmittal untuk folder ini.' }}
                </p>
            </div>
            ...
            <div class="header-meta">
                <div class="meta-row">
                    ...
                    <span class="meta-val">{{ $project->project_number ?? '—' }}</span>
                </div>
                <div class="meta-row">
                ...
                @if ($last)
                    ...
                    <div class="meta-update">
                        <h5 class="meta-label">Update Terakhir</h5>
                        <a href="{{ route('document.show', $last->id) }}"
                            title="{{ $lastTitle }}">{{ $lastTitle }}</a>
                        <p>Oleh {{ $lastUser }} &bull; {{ $lastDate }}</p>
                    </div>
                @endif
            </div>
        </div>
        ...
        <div class="toolbar">
            <div class="toolbar-left">
                <div class="search-box">
                    ...
                    <input id="searchInput" type="search" placeholder="Cari nama dokumen, nomor, atau revisi..."
                        autocomplete="off" />
                </div>
            ...
            <div class="toolbar-right">
                ...
                @if ($documents->count() > 0)
                    <a href="{{ route('portal.document.download.all', ['project' => $project->id, 'folder' => $folder->id]) }}"
                        ...
                        <i class="bx bx-download"></i> Download Semua
                    </a>
                @endif
            </div>
        </div>
                                ...
                                <td>
                                    <div class="file-cell">
                                        ...
                                        <div>
                                            ...
                                            <div class="file-meta">{{ $extLabel }} &bull; {{ $sizeDisplay }}</div>
                                        </div>
                                    </div>
                                </td>
                                <td style="font-family: monospace; font-weight: 600;">{{ $doc->document_no ?: '—' }}</td>
                                <td><span
                                        style="background: var(--bg); padding: 4px 8px; border-radius: 6px; font-family: monospace; font-weight: 700; color: var(--muted);">v{{ $doc->revision ?: '0' }}</span>
                                </td>
                                <td>
                                    ...
                                    <div class="action-btns">
                                        @if ($exists)
                                            @if (in_array($ext, ['pdf', 'html', 'htm']))
                                                <button type="button" class="btn-icon preview" title="Preview"
                            ...
                            <tr>
                                <td colspan="6">
                                    <div class="empty-state">
                                        ...
                                        <p>Folder ini belum memiliki dokumen. Silakan klik "Tambah Dokumen" untuk mengunggah
                                            file pertama Anda.</p>
                                    </div>
                                </td>
                            </tr>
    ...
    <div id="documentModal" class="modal" aria-hidden="true" role="dialog" aria-labelledby="documentModalTitle">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h3 id="documentModalTitle" class="modal-title"><i class="bx bx-file-blank"></i> Tambah Dokumen</h3>
            ...
            <div class="modal-body" id="documentModalBody">
                <form id="documentForm" method="POST" enctype="multipart/form-data" novalidate>
                    ...
                    <div class="form-row">
                        <div class="form-group" style="flex: 2; min-width: 200px;">
                            ...
                            <input id="f_document_no" name="document_no" type="text" class="form-control"
                                placeholder="Tuliskan nomor registrasi file">
                        </div>
                    ...
                    <div class="form-group"
                        style="margin-bottom: 0.5rem; display: flex; align-items: center; justify-content: space-between; background: var(--bg); padding: 10px 14px; border-radius: 8px; border: 1px solid var(--border);">
                        <div>
                            <label style="margin:0; font-size: 0.9rem;">Status Dokumen</label>
                            <span class="small-muted" style="margin: 0;">Dokumen "Final" tidak dapat diubah lagi.</span>
                        </div>
                        <div style="display: flex; align-items: center; gap: 10px;">
                            <span style="font-weight: 700; font-size: 0.85rem;" id="statusLabel">DRAFT</span>
                    ...
                    <div class="form-group" style="margin-top: 1.5rem;">
                        <label for="f_file">Unggah File <span style="color:var(--danger)">*</span></label>
                        <input id="f_file" name="file" type="file" class="form-control"
                            accept=".pdf,application/pdf" style="padding: 0.5rem;">
                        <div id="f_fileHelp" class="small-muted">Format PDF, maksimal ukuran 20MB.</div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="f_description" name="description" class="form-control" rows="2"
                    ...
                    <div class="modal-actions">
                        ...
                        <button type="submit" id="f_btnSave" class="btn-action">
                            <span id="f_btnText">Simpan Dokumen</span>
                        </button>
                    </div>
                </form>
            </div>
    ...
    <script>
        (function() {
            ...
            function createProgressOverlay() {
                ...
                overlay.innerHTML = `
            <div style="width:360px; max-width:92%; background:#fff; border-radius:12px; padding:20px; box-shadow:0 10px 40px rgba(0,0,0,0.2); text-align:left; font-family:'Plus Jakarta Sans',sans-serif;">
                <div style="display:flex; align-items:center; gap:12px; margin-bottom:12px;">
                    <div style="width:48px; height:48px; border-radius:10px; background:linear-gradient(135deg,#2563eb,#7c3aed); display:flex; align-items:center; justify-content:center; color:#fff;"><i class="bx bx-cloud-download" style="font-size:24px;"></i></div>
                    <div style="flex:1;">
                        <div id="downloadProgressTitle" style="font-weight:800; color:#0f172a; font-size:15px; margin-bottom:2px;">Mengunduh...</div>
                        <div id="downloadProgressSub" style="font-size:13px; color:#64748b; font-weight:500;">Menyiapkan koneksi</div>
                    </div>
                </div>
                <div>
                    ...
                    <div style="display:flex; justify-content:space-between; align-items:center; margin-top:12px;">
                        <div id="downloadProgressPercent" style="font-size:13px; color:#0f172a; font-weight:800;">0%</div>
                        <button id="downloadProgressCancel" style="background:transparent; border:1px solid #e2e8f0; padding:6px 12px; border-radius:8px; font-weight:700; color:#64748b; cursor:pointer; font-size:12px;">Batal</button>
                    </div>
                </div>
            </div>
        `;
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function initFileHelper() {
                ...
                fileIn.addEventListener('change', function() {
                    ...
                    if (!this.files.length) {
                        help.textContent = 'Format PDF, maksimal ukuran 20MB.';
                        return;
                    }

                    const f = this.files[0];
                    if (f.type !== 'application/pdf' && !f.name.toLowerCase().endsWith('.pdf')) {
                        errTxt.textContent = 'Harap pilih file berformat PDF.';
                ...
                $('#documentForm')?.addEventListener('submit', function(e) {
                    if (!fileIn.files.length && !$('#documentFormMethod').value.includes('PUT')) {
                        e.preventDefault();
                        errTxt.textContent = 'File dokumen wajib diunggah!';
                        errBox.style.display = 'flex';
                        fileIn.classList.add('is-invalid');
                    }
                });
            ...
            // Action Functions
            function openAdd() {
                modalTitle.innerHTML = '<i class="bx bx-file-blank"></i> Tambah Dokumen';
                modalBody.innerHTML = originalFormHTML;
            ...
            function openUpdate(data) {
                modalTitle.innerHTML = '<i class="bx bx-pencil"></i> Edit Dokumen';
                modalBody.innerHTML = originalFormHTML;
                ...
                if ($('#f_fileHelp')) $('#f_fileHelp').innerHTML =
                    'Biarkan kosong jika <b>tidak ingin mengganti</b> file PDF.';
            ...
            function openPreview(url, title) {
                modalTitle.innerHTML = `<i class="bx bx-show"></i> Preview Dokumen`;
                modalBody.innerHTML = `
                    <div style="height: 75vh; border-radius: 12px; overflow: hidden; background: #f1f5f9; display:flex; align-items:center; justify-content:center;">
            ...
            document.addEventListener('keydown', (e) => {
                if (e.key === 'Escape' && modalRoot.getAttribute('aria-hidden') === 'false') {
                    hideModal();
                }
            });
            ...
            document.querySelectorAll('.form-delete').forEach(form => {
                form.addEventListener('submit', function(e) {
                    ...
                    Swal.fire({
                        title: 'Hapus Dokumen?',
                        text: "File PDF dan data akan terhapus permanen.",
                        icon: 'warning',
